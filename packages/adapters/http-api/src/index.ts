...
export class HttpApiAdapterPlaceholder implements Adapter {
  ...
  async authenticate(_payload: AuthPayload): Promise<AdapterAuthResult> {
    throw new Error("TODO: HTTP API adapter auth not implemented in v1.");
  }
  ...
  async runTrigger(
    ...
    throw new Error("TODO: HTTP API adapter trigger not implemented in v1.");
  }
  async runAction(
    _actionKey: string,
    _input: Record<string, unknown>,
    ...
    throw new Error("TODO: HTTP API adapter action not implemented in v1.");
  }
