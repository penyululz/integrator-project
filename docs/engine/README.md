# Engine Documentation Hub

Use this directory as the canonical backend-engine guide.

- [LLM Full Documentation](./LLM_FULL_DOCUMENTATION.md)
- [Architecture Map](./ARCHITECTURE_MAP.md)
- [Integration Playbook](./INTEGRATION_PLAYBOOK.md)
- [Portable Engine Guide](./PORTABLE_ENGINE_GUIDE.md)
...
1. `LLM_FULL_DOCUMENTATION.md`
2. `PORTABLE_ENGINE_GUIDE.md`
3. `INTEGRATION_PLAYBOOK.md`
4. `PORTABILITY_CHECKLIST.md`
